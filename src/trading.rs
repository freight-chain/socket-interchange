...
#[shrinkwrap(mutable)]
pub struct TransactionHeader(pub TradeChannel);

#[derive(Deserialize, Serialize, Debug, Clone, Shrinkwrap)]
#[shrinkwrap(mutable)]
pub struct TransactionHeaderResponse(pub TradeResponse);

impl TransactionHeader {
    pub fn market(instrument_name: &str, amount: f64) -> TransactionHeader {
        TransactionHeader(TradeChannel::market(instrument_name, amount))
    }
    pub fn limit(instrument_name: &str, price: f64, amount: f64) -> TransactionHeader {
        TransactionHeader(TradeChannel::limit(instrument_name, amount, price))
    }
}

impl Request for TransactionHeader {
    const METHOD: &'static str = "private/buy";
    type Response = TransactionHeaderResponse;
}

#[derive(Deserialize, Serialize, Clone, Debug, Shrinkwrap)]
#[shrinkwrap(mutable)]
pub struct TransactionTrailerResponse(pub TradeChannel);

#[derive(Deserialize, Serialize, Debug, Clone, Shrinkwrap)]
#[shrinkwrap(mutable)]
pub struct SellResponse(pub TradeResponse);

impl TransactionTrailerResponse {
    pub fn market(instrument_name: &str, amount: f64) -> TransactionTrailerResponse {
        TransactionTrailerResponse(TradeChannel::market(instrument_name, amount))
    }
    pub fn limit(instrument_name: &str, price: f64, amount: f64) -> TransactionTrailerResponse {
        TransactionTrailerResponse(TradeChannel::limit(instrument_name, amount, price))
    }
}

impl Request for TransactionTrailerResponse {
...
impl TradeChannel {
    pub fn market(instrument_name: &str, amount: f64) -> TradeChannel {
        TradeChannel {
    ...
    pub fn limit(instrument_name: &str, amount: f64, price: f64) -> TradeChannel {
        TradeChannel {
            instrument_name: instrument_name.into(),
            amount: amount,
...
/// @dev this needs improvement, enhanced bidding langauge 
